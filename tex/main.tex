...
the data used for training, while in \citet{chattopadhyay_long-term_2023} the
authors devise a Runge-Kutta scheme to reduce the bias on subsampled data.
...
hierarchical time stepping scheme in \citet{bi_pangu-weather_2022} (both
