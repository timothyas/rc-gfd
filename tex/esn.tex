...
However, we make two notes about this tradeoff.
First, the relative reduction in KE\_NRMSE is more than double the increase in NRMSE ($>50\%$ vs $\sim20\%$),
indicating that the slightly increased NRMSE is worthwhile.
Secondly, and more importantly, our purpose is to generate forecasts that are as representative
...
Moreover, we conjecture that capturing the small scale processes will be important for ensemble forecasting
because the small scale, nonlinear processes will likely be important for accurately capturing ensemble
spread \citep{kalnay_ensemble_2006}.
